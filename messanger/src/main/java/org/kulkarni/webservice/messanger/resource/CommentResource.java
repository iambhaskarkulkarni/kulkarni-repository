...
import org.kulkarni.webservice.messanger.service.CommentService;
...
public class CommentResource {
	...
	@DELETE
	@Path("/{commentId}")
	public Comment deleteCommente(@PathParam("messageId") long messageId, @PathParam("commentId") long commentId) {
